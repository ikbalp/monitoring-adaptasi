...
<html lang="en">
    <head>
        ...
        <meta http-equiv="refresh" content="5" /> <!-- refresh 5sec untuk jmlh pengunjung & tabel data suhu --->
        <title>Tables - Monitoring New Normal</title>
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                            <h5> Total Pengunjung : <?=$count1;?> dari 100 </h5>
                                    </div>
                                </div>
                            </div>
